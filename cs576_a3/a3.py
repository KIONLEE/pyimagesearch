...
def decoder(grid):
    ...
    bboxes_all = (grid_coord_ltrb[:,:4]) # [S X S X B, 4], we only need (left_top_x, left_top_y, right_bottom_x, right_bottom_y) for each boxes
    probs_all = (grid_coord_ltrb[:,4]) # [S X S X B]
